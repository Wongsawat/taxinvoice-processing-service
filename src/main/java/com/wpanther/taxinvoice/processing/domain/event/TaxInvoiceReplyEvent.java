...
public class TaxInvoiceReplyEvent extends SagaReply {
     ...
     */
    public static TaxInvoiceReplyEvent success(String sagaId, SagaStep sagaStep, String correlationId) {
     ...
     */
    public static TaxInvoiceReplyEvent failure(String sagaId, SagaStep sagaStep, String correlationId,
                                                String errorMessage) {
     ...
     */
    public static TaxInvoiceReplyEvent compensated(String sagaId, SagaStep sagaStep, String correlationId) {
    ...
    private TaxInvoiceReplyEvent(String sagaId, SagaStep sagaStep, String correlationId, ReplyStatus status) {
        super(sagaId, sagaStep, correlationId, status);
    }

    // For FAILURE (delegates to SagaReply 4-arg error constructor)
    private TaxInvoiceReplyEvent(String sagaId, SagaStep sagaStep, String correlationId, String errorMessage) {
